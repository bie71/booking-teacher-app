    ...
    <div class="container py-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div v-else class="space-y-4">
              ...
              >
                <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
                  <template v-if="lesson.schedule?.teacher?.profile_image">
                    <img 
                      :src="lesson.schedule.teacher.profile_image" 
                      :alt="lesson.schedule.teacher.name" 
        ...
        <div class="card">
          ...
          <div class="card-body">
            <!-- Display a placeholder when there are no activities -->
...
// Access the favorites store for managing favorite teachers
const favoritesStore = useFavoritesStore()
// Computed property to reflect the list of favorite teacher IDs
...
const fetchRecentActivities = async () => {
  ...
  try {
    ...
    recentActivities.value = result.activities || result.data || result || []
  } catch (error) {
...
const fetchDashboardData = async () => {
  ...
  // Fetch favorites so the count updates accordingly
